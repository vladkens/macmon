...
- Added an optional `app` feature so Rust library users can exclude CLI and TUI dependencies with `--no-default-features`
...
**Full Changelog**: https://github.com/vladkens/macmon/compare/v0.8.0...v0.8.1
